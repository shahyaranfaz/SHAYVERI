...
# Master-side consumer for SHAYVERI NNUE v2.10 data.
...
TRAIN_ID="${TRAIN_ID:-shayveri_v2.10_kb8}"
START_ITER="${START_ITER:-0}"
MAX_CHUNKS="${MAX_CHUNKS:-1000}" # 0 means run forever.
POLL_SECONDS="${POLL_SECONDS:-10}"
INITIAL_RESUME="${INITIAL_RESUME:-$HOME/nnue_v2_9/out/shayveri_v2.9_kb8_iter010-1}"
RESUME="${RESUME:-}"

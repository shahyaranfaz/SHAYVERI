...
# Master-side consumer for SHAYVERI NNUE v2.1 data.
...
NFS_ROOT="${NFS_ROOT:-$HOME/nnue_v2_1}"
...
TRAIN_ID="${TRAIN_ID:-shayveri_v2.1}"
START_ITER="${START_ITER:-0}"
MAX_CHUNKS="${MAX_CHUNKS:-0}" # 0 means run forever.
POLL_SECONDS="${POLL_SECONDS:-10}"
RESUME="${RESUME:-}"

LR="${LR:-0.001}"
LR_DROP_CHUNK="${LR_DROP_CHUNK:-20}"
LR_AFTER_DROP="${LR_AFTER_DROP:-0.0001}"
SECOND_LR_DROP_CHUNK="${SECOND_LR_DROP_CHUNK:-32}"

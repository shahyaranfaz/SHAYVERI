...
# Master-side consumer for SHAYVERI NNUE v2.9 data.
...
NFS_ROOT="${NFS_ROOT:-$HOME/nnue_v2_9}"
...
TRAIN_ID="${TRAIN_ID:-shayveri_v2.9_kb8}"
...
SECOND_LR_AFTER_DROP="${SECOND_LR_AFTER_DROP:-0.00003}"
EPOCHS="${EPOCHS:-1}"

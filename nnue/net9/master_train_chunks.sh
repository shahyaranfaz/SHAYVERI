...
# Master-side consumer for SHAYVERI NNUE v2.8 data.
...
NFS_ROOT="${NFS_ROOT:-$HOME/nnue_v2_8}"
...
TRAIN_ID="${TRAIN_ID:-shayveri_v2.8_kb8}"
...
LR="${LR:-0.001}"
LR_DROP_CHUNK="${LR_DROP_CHUNK:-500}"
LR_AFTER_DROP="${LR_AFTER_DROP:-0.0003}"
SECOND_LR_DROP_CHUNK="${SECOND_LR_DROP_CHUNK:-1000}"

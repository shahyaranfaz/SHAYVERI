...
NODES="${NODES:-2500}"
OPENING_MIN_PLIES="${OPENING_MIN_PLIES:-8}"
OPENING_MAX_PLIES="${OPENING_MAX_PLIES:-8}"
BOOK_MOVE_PROBABILITY="${BOOK_MOVE_PROBABILITY:-0.85}"
MAX_ABS_CP="${MAX_ABS_CP:-3000}"
INCLUDE_CHECKS="${INCLUDE_CHECKS:-false}"
INCLUDE_CAPTURES="${INCLUDE_CAPTURES:-false}"
INCLUDE_MATE_SCORES="${INCLUDE_MATE_SCORES:-false}"

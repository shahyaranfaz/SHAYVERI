...
inline std::unordered_map<std::string, TuningOption> tuning_registry = {
    ...
    {"LMR_Scale",           {&lmr_scale,              TuningOption::DOUBLE,  0,     0,   "1.73"}}, // DOUBLE ignores min/max
    {"RFP_Margin",          {&rfp_margin_mult,        TuningOption::INT,    40,   160,  "79"}},
    {"FP_Base",             {&fp_base,                TuningOption::INT,   110,   330,  "192"}},
    {"FP_Mult",             {&fp_mult,                TuningOption::INT,   400,   950,  "575"}},
    ...
    {"SE_Margin",           {&se_margin,              TuningOption::INT,    25,    95,  "56"}},
    ...
    // ── Pawn structure ────────────────────────────────────────────
    {"Isolated_MG",         {&ISOLATED_PAWN_PENALTY_MG, TuningOption::INT, -35,     0,   "-1"}},
    {"Isolated_EG",         {&ISOLATED_PAWN_PENALTY_EG, TuningOption::INT, -28,     0,   "-3"}},
    ...
    {"Backward_EG",         {&BACKWARD_PAWN_PENALTY_EG, TuningOption::INT, -25,     0,   "0"}},

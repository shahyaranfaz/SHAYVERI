...
|-------:|-----------------:|-------:|-------:|-------------:|------------------------------------:|----------------------:|---------:|
|     v2 | `Chess768x256-L` |    768 |    256 | clipped ReLU |                          one linear | v2.0.0-v2.1.0, v2.3.0 |      YES |
|     v2 | `Chess768x512-L` |    768 |    512 | clipped ReLU |                          one linear |                 never |      YES |
|     v3 |      `KB8x256-L` |  6,144 |    256 |       SCReLU |                          one linear |                v2.2.0 |      YES |
|     v3 |      `KB8x512-L` |  6,144 |    512 |       SCReLU |                          one linear |                 never |      YES |
|     v3 |     `KB16x256-L` | 12,288 |    256 |       SCReLU |                          one linear |                v2.4.0 |      YES |
|     v3 |     `KB16x512-L` | 12,288 |    512 |       SCReLU |                          one linear |          v2.5-v2.10.1 |      YES |
